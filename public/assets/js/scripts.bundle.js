    ...
    var Plugin = {
        ...
        getPrevStep: function() {
            if ((the.currentStep - 1) >= 1) {
                var stepnumber = (the.currentStep - 1);

                if (stepnumber == 1) {
                    $('body').find('.wizard-step-2').addClass('d-none')
                    $('body').find('.wizard-step-3').addClass('d-none')
                    $('body').find('.wizard-step-4').addClass('d-none')
        ...
        setNewStep: function(step) {
            if (step == 2) {
                $('body').find('.wizard-step-2').removeClass('d-none');
                var surveyid = $('body').find('.survey_id').val();
                var q1 = $('body').find('.option_select').val();
                var q2 = $('body').find('.areatext').val();
                var q3 = $('body').find('.id_city').val();
                var q4 = $('body').find('.shop_survey').val();
                ...
                axios
                .post('/ws/backupsteap1',{ params:{ surveyid,q1,q2,q3,q4 } })
                .then(response => {
                })
                .catch(res=>console.log(res));
            }else if(step == 3){
                var option = $('body').find('.select-answer-finish').val();
                ...
                if (option == 75) {
                    ...
                    axios
                    .post('/ws/copubackupsteap1',{ params:{ surveyid,q1,q2,q3,q4 } })
                    .then(response => {
                    })
                    .catch(res=>console.log(res));
                }else if (option == 76) {
                ...
                $('body').find('.wizard-step-3').removeClass('d-none')
            }else if(step == 4){
                $('body').find('.wizard-step-4').removeClass('d-none')
            }
            the.newStep = step;
        },
