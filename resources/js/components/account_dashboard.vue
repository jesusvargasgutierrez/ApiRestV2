            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
               ...
               <form id="kt_account_profile_details_form" class="form">
                  ...
                  <div class="card-body border-top p-9">
                     ...
                     <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                           <input type="password" name="password" class="form-control form-control-lg form-control-solid" placeholder="Password" value="123" />
                        </div>
                        <!--end::Col-->
                     </div>
                     <!--end::Input group-->
                     ...
                     <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                           <input type="text" name="email" class="form-control form-control-lg form-control-solid" placeholder="Company email" value="keenthemes@codersweb.com" />
                        </div>
                        <!--end::Col-->
                     </div>
                     <!--end::Input group-->
                     ...
                     <div class="row mb-6">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-semibold fs-6">Datebird</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                  ...
                  <div class="card-footer d-flex justify-content-end py-6 px-9">
                     ...
                     <button type="button" class="btn btn-primary" v-on:click="click_save" id="kt_account_profile_details_submit">Save Changes</button>
                  </div>
                  <!--end::Actions-->
               </form>
               <!--end::Form-->
   ...
   export default{
      ...
      methods: {
         ...
         click_save(){
            ...
            console.log(this.jsonfrm);

            axios.post('http://testapp.test/ws/insertrecord', this.jsonfrm, {
               headers: {
