<template>
         <div class="card card-flush h-lg-100" id="kt_contacts_main">
                  ...
                  <div class="card-body pt-5">
                     <!--begin::Form-->
                     <div id="kt_ecommerce_settings_general_form" class="form">
                        <div class="fv-row mb-7 div-row-control">
                           <!--begin::Label-->
                           ...
                           <!--end::Label-->
                           <!--begin::Input-->
                           <input type="text" data-name="fullname" class="form-control form-control-solid" name="name" value="" />
                           <!--end::Input-->
                        </div>
                        <div class="fv-row mb-7 div-row-control">
                           <!--begin::Label-->
                           ...
                           <!--end::Label-->
                           <!--begin::Input-->
                           <input type="text" data-name="company_name" class="form-control form-control-solid" name="company_name" value="" />
                           <!--end::Input-->
                        </div>
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                           ...
                           <div class="col">
                              ...
                              <div class="fv-row mb-7 div-row-control">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="email" data-name="email" class="form-control form-control-solid" name="email" value="" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Input group-->
                           </div>
                           ...
                           <div class="col">
                              ...
                              <div class="fv-row mb-7 div-row-control">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" data-name="phone" class="form-control form-control-solid" name="phone" value="" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Input group-->
                           </div>
                        ...
                        <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                           ...
                           <div class="col">
                              ...
                              <div class="fv-row mb-7 div-row-control">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="text" data-name="city" class="form-control form-control-solid" name="city" value="" />
                                 <!--end::Input-->
                              </div>
                              <!--end::Input group-->
                           </div>
                           ...
                           <div class="col">
                              ...
                              <div class="fv-row mb-7">
                                 ...
                                 <!--end::Label-->
                                 <div class="w-100 div-row-control">
                                    <!--begin::Select2-->
   ...
   export default{
      ...
      methods: {
         add_customer(){
            ...
            ,{ params: { '_token': 'Um4dP8K5tYZ6yGVYZRQIYJiRE0l706PAyB48oS2l', 'EndpointName': 'contacts' }} )
            .then(response => {
